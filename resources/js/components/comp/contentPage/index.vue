<template>
    <div id="tezeer-content">
        <div>
        </div>

        <div class="col-sm-12 col-md-10 col-lg-8 m-auto p-0 pl-1 pr-1 pt-3" style="padding-bottom: 5rem !important;">
            <div class="row rtl">
                <div v-for="(product, index ) in this.$store.state.teezers" :key="index"
                     class="col-lg-4 col-md-6 col-sm-12 mt-2 mb-2  a-none">
                    <router-link v-bind:to="'/showTeezer/'+product.category_id+'/'+product.slug">
                        <div class="col-12 m-auto p-0">
                            <div class=" col-12 p-0 card m-auto">
                                ...
                                <img src="../../../../../public/1.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 1" class="image-card">
                                <img src="../../../../../public/2.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 2" class="image-card">
                                <img src="../../../../../public/3.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 3" class="image-card">
                                <img src="../../../../../public/4.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 4" class="image-card">
                                <img src="../../../../../public/5.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 5" class="image-card">
                                <img src="../../../../../public/6.jpg" v-show="product.image1 === null"
                                     v-if="product.category_id === 6" class="image-card">
                            </div>
                            <div class="col-12 p-0">
                                <div class="col-11 card card-1 information-box">
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="row">
                                            ...
                                            <div class="col-4  text-light br-myTeezerpink f-10">
                                                <div class="text-center rtl text-pink" v-if="product.category_id === 1">
                                                    کتاب و جزوه
                                                </div>
                                                <div class="text-center rtl text-pink" v-if="product.category_id === 2">
                                                    وسایل خونه
                                                </div>
                                                <div class="text-center rtl text-pink" v-if="product.category_id === 3">
                                                    هم
                                                    مسیر
                                                </div>
                                                ...
                                                <div class="text-center rtl text-pink" v-if="product.category_id === 5">
                                                    هم
                                                    خونه
                                                </div>
                                    ...
                                    <div class="col-12 mt-2 mb-2">
                                        <div class="row">
                                            <div class="col-6 p-0 text-right text-sormei f-10">
                                                <i class="far fa-calendar-alt pl-1 text-new-red"></i>{{
                                                product.created_at}}
                                            </div>
                                            <div class="col-6 p-0 pt-1 text-sormei f-10">
        ...
        <div class="col-sm-12 col-md-12 col-sm-12 " style="padding-bottom: 5rem"
             v-show="this.$store.state.teezers.length >=19 || this.$store.state.page.last_page_num >= 2">
